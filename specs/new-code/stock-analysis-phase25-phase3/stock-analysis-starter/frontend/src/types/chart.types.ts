...
export interface MultiTimeframeChartsDto { instrumentId: number; exchangeCode: ExchangeCode; symbol: string; series: { week?: ChartSeriesDto | null; day?: ChartSeriesDto | null; hour?: ChartSeriesDto | null; }; overlays?: { week?: ChartOverlayDto | null; day?: ChartOverlayDto | null; hour?: ChartOverlayDto | null; }; }
